...
class SystemAPITest(unittest.TestCase):
    ...
    def test_get_system_no_include_commands(self, mock_get):
        ...
        response = self.app.get(
            "/api/v1/systems/%s?include_commands=false" % self.default_system.id
        )
        self.assertEqual(200, response.status_code)
    ...
    def test_get_not_found(self):
        self.assertEqual(
            404, self.app.get("/api/v1/systems/54ac18f778c4b57e963f3c18").status_code
        )
    ...
    def test_put(self, get_mock, save_mock):
        ...
        response = self.app.put(
            "/api/v1/systems/%s" % self.default_system.id,
    ...
    def test_put_not_found(self):
        self.assertEqual(
            404, self.app.put("/api/v1/systems/54ac18f778c4b57e963f3c18").status_code
        )
    ...
    def test_patch_reload(self, context_mock, get_mock):
        ...
        self.client_mock.reloadSystem.assert_called_once_with(
            str(self.default_system.id)
        )
    ...
    def test_patch_not_found(self):
        self.assertEqual(
            404, self.app.patch("/api/v1/systems/54ac18f778c4b57e963f3c18").status_code
        )
